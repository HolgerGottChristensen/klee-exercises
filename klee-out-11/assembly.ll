...
41:                                               ; preds = %20
  ...
  %60 = load i32, i32* %8, align 4, !dbg !684
  %61 = load i32, i32* %9, align 4, !dbg !685
  %62 = icmp eq i32 %60, %61, !dbg !686
  %63 = zext i1 %62 to i32, !dbg !686
  %64 = sext i32 %63 to i64, !dbg !684
  call void @klee_assume(i64 %64), !dbg !687
  ret i32 0, !dbg !688
}
...
17:                                               ; preds = %17, %15
  ...
  %22 = load <16 x i8>, <16 x i8>* %21, align 1, !tbaa !689, !alias.scope !692
  %23 = getelementptr i8, i8* %19, i64 16
  %24 = bitcast i8* %23 to <16 x i8>*
  %25 = load <16 x i8>, <16 x i8>* %24, align 1, !tbaa !689, !alias.scope !692
  %26 = bitcast i8* %20 to <16 x i8>*
  store <16 x i8> %22, <16 x i8>* %26, align 1, !tbaa !689, !alias.scope !695, !noalias !692
  %27 = getelementptr i8, i8* %20, i64 16
  %28 = bitcast i8* %27 to <16 x i8>*
  store <16 x i8> %25, <16 x i8>* %28, align 1, !tbaa !689, !alias.scope !695, !noalias !692
  %29 = add nuw i64 %18, 32
  %30 = icmp eq i64 %29, %16
  br i1 %30, label %31, label %17, !llvm.loop !697
...
45:                                               ; preds = %45, %39
  ...
  %50 = load <8 x i8>, <8 x i8>* %49, align 1, !tbaa !689
  %51 = bitcast i8* %48 to <8 x i8>*
  store <8 x i8> %50, <8 x i8>* %51, align 1, !tbaa !689
  %52 = add nuw i64 %46, 8
  %53 = icmp eq i64 %52, %41
  br i1 %53, label %54, label %45, !llvm.loop !699
...
60:                                               ; preds = %56, %60
  ...
  %66 = load i8, i8* %61, align 1, !tbaa !689
  %67 = getelementptr inbounds i8, i8* %62, i64 1
  store i8 %66, i8* %62, align 1, !tbaa !689
  %68 = icmp eq i64 %64, 0
  br i1 %68, label %69, label %60, !llvm.loop !700
...
!684 = !DILocation(line: 222, column: 17, scope: !621)
!685 = !DILocation(line: 222, column: 25, scope: !621)
!686 = !DILocation(line: 222, column: 22, scope: !621)
!687 = !DILocation(line: 222, column: 5, scope: !621)
!688 = !DILocation(line: 224, column: 5, scope: !621)
!689 = !{!690, !690, i64 0}
!690 = !{!"omnipotent char", !691, i64 0}
!691 = !{!"Simple C/C++ TBAA"}
!692 = !{!693}
...
!697 = distinct !{!697, !174, !698}
!698 = !{!"llvm.loop.isvectorized", i32 1}
!699 = distinct !{!699, !174, !698}
!700 = distinct !{!700, !174, !698}
