...
41:                                               ; preds = %20
  ...
  %60 = call i32 @klee_is_replay(), !dbg !684
  %61 = icmp ne i32 %60, 0, !dbg !684
  br i1 %61, label %62, label %64, !dbg !686

62:                                               ; preds = %41
  %63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)), !dbg !687
  br label %64, !dbg !689

64:                                               ; preds = %62, %41
  %65 = load i32, i32* %8, align 4, !dbg !690
  %66 = load i32, i32* %9, align 4, !dbg !691
  %67 = icmp eq i32 %65, %66, !dbg !692
  %68 = zext i1 %67 to i32, !dbg !692
  %69 = sext i32 %68 to i64, !dbg !690
  call void @klee_assume(i64 %69), !dbg !693
  ret i32 0, !dbg !694
}
...
17:                                               ; preds = %17, %15
  ...
  %22 = load <16 x i8>, <16 x i8>* %21, align 1, !tbaa !695, !alias.scope !698
  %23 = getelementptr i8, i8* %19, i64 16
  %24 = bitcast i8* %23 to <16 x i8>*
  %25 = load <16 x i8>, <16 x i8>* %24, align 1, !tbaa !695, !alias.scope !698
  %26 = bitcast i8* %20 to <16 x i8>*
  store <16 x i8> %22, <16 x i8>* %26, align 1, !tbaa !695, !alias.scope !701, !noalias !698
  %27 = getelementptr i8, i8* %20, i64 16
  %28 = bitcast i8* %27 to <16 x i8>*
  store <16 x i8> %25, <16 x i8>* %28, align 1, !tbaa !695, !alias.scope !701, !noalias !698
  %29 = add nuw i64 %18, 32
  %30 = icmp eq i64 %29, %16
  br i1 %30, label %31, label %17, !llvm.loop !703
...
45:                                               ; preds = %45, %39
  ...
  %50 = load <8 x i8>, <8 x i8>* %49, align 1, !tbaa !695
  %51 = bitcast i8* %48 to <8 x i8>*
  store <8 x i8> %50, <8 x i8>* %51, align 1, !tbaa !695
  %52 = add nuw i64 %46, 8
  %53 = icmp eq i64 %52, %41
  br i1 %53, label %54, label %45, !llvm.loop !705
...
60:                                               ; preds = %56, %60
  ...
  %66 = load i8, i8* %61, align 1, !tbaa !695
  %67 = getelementptr inbounds i8, i8* %62, i64 1
  store i8 %66, i8* %62, align 1, !tbaa !695
  %68 = icmp eq i64 %64, 0
  br i1 %68, label %69, label %60, !llvm.loop !706
...
!684 = !DILocation(line: 222, column: 9, scope: !685)
!685 = distinct !DILexicalBlock(scope: !621, file: !12, line: 222, column: 9)
!686 = !DILocation(line: 222, column: 9, scope: !621)
!687 = !DILocation(line: 223, column: 9, scope: !688)
!688 = distinct !DILexicalBlock(scope: !685, file: !12, line: 222, column: 27)
!689 = !DILocation(line: 224, column: 5, scope: !688)
!690 = !DILocation(line: 225, column: 17, scope: !621)
!691 = !DILocation(line: 225, column: 25, scope: !621)
!692 = !DILocation(line: 225, column: 22, scope: !621)
!693 = !DILocation(line: 225, column: 5, scope: !621)
!694 = !DILocation(line: 227, column: 5, scope: !621)
!695 = !{!696, !696, i64 0}
...
!703 = distinct !{!703, !174, !704}
!704 = !{!"llvm.loop.isvectorized", i32 1}
!705 = distinct !{!705, !174, !704}
!706 = distinct !{!706, !174, !704}
